...
function About() {
  ...
  return (
    <div className="w-full flex justify-center items-center 2xl:h-[550px] xl:h-[550px] lg:h-[550px] md:h-[550px] sm:h-[600px] xs:h-[800px] 2xs:h-[1050px] bg-green-xx">
        <div className=" h-[90%] bg-fink-99 rounded-[10px] content-center mx-auto 2xl:w-[700px] xl:w-[700px] md:w-[700px] sm:w-[600px] xs:w-[400px] 2xs:w-[300px] ">
          <div className="w-[90%] h-[90%] bg-white mx-auto p-[5px] rounded-[10px] hover:translate-y-[-10px] duration-300 active:scale-90">
