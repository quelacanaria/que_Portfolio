...
function About({Id}) {
  ...
  return (
    <div id={Id} className="w-full flex justify-center items-center 2xl:h-[550px] xl:h-[550px] lg:h-[550px] md:h-[550px] sm:h-[600px] xs:h-[800px] 2xs:h-[1050px] bg-green-xx">
